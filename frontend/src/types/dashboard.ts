...
export interface GlobalDisasterSnapshot {
...
export interface BorderStatusSnapshot {
...
export interface DashboardData {
  ...
  gdelt?: GDELTIncident[];
  global_disasters?: GlobalDisasterSnapshot;
  border_status?: BorderStatusSnapshot;
  airports?: Airport[];
  kiwisdr?: KiwiSDR[];
