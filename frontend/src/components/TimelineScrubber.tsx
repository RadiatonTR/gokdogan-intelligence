        ...
        {isSnapshot ? (
          ...
          <div className="flex items-center gap-2 mb-1">
            ...
            <button
              ...
              title={tmTooltipDismissed ? undefined : (tmEnabled ? 'Anlık görüntüleri kapatmak için tıklayın (~68 MB/gün)' : 'Anlık görüntüleri açmak için tıklayın (~68 MB/gün)')}
            >
              {tmEnabled ? 'ANLIK GÖRÜNTÜLER AÇIK' : 'ANLIK GÖRÜNTÜLER KAPALI'}
            </button>
          </div>
        )}
