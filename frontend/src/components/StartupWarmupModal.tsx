              ...
              <div className="flex items-start gap-3">
                ...
                <div className="space-y-2">
                  <p className="text-[11px] text-cyan-300 font-mono font-bold tracking-widest">
                    YOĞUN VERİ HAZIRLIĞI
                  </p>
                  <p className="text-sm text-[var(--text-secondary)] font-mono leading-relaxed">
                    İlk açılışta uçuşlar, gemiler, uydular, kamu kameraları, yangınlar ve tehdit verileri için yerel önbellek hazırlanır. Sonraki açılışlarda harita çok daha hızlı dolar; yeni kurulumda veri kaynakları ilk kez birleştirilirken bu işlem birkaç dakika sürebilir.
                  </p>
                </div>
              </div>
            </div>
