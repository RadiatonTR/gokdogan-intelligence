...
const COMING_SOON_MODULES: Record<string, { title: string; desc: string; status: string }> = {
  ...
  EXCHANGE: {
    ...
    desc: 'Experimental testnet market lab. Privacy-coin/DEX primitives are unaudited scaffolding and are disabled by default; do not treat them as private settlement.',
    ...
    if (trimmedCmd === 'help') {
      ...
      output = (
        <div className="text-gray-400">
          ...
          <p className="text-gray-500 mt-1">Durum: <span className="text-green-400">ÇEVRİMİÇİ</span></p>
