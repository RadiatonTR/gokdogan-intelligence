...
const SPEED_OPTIONS = [
  ...
  { label: 'YAVAŞ', value: 12, desc: 'Anlık görüntüler arasında 12 saniye' },
  { label: 'ÇOK YAVAŞ', value: 20, desc: 'Anlık görüntüler arasında 20 saniye' },
];
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className={`text-[11px] font-mono tracking-wider ${tmEnabled ? 'text-emerald-400' : 'text-red-400/60'}`}>
                {tmEnabled ? 'CANLI KAYIT AÇIK' : 'ANLIK GÖRÜNTÜLER KAPALI'}
              </span>
            </div>
