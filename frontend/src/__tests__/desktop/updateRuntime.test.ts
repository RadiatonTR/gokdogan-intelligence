...
const RELEASE: GitHubLatestRelease = {
  ...
  assets: [
    { name: 'Gökdoğan_0.9.84_x64_en-US.msi', browser_download_url: 'https://example.test/windows.msi' },
    { name: 'Gökdoğan_0.9.84_x64-setup.exe', browser_download_url: 'https://example.test/windows-setup.exe' },
    { name: 'Gökdoğan_0.9.84_aarch64.dmg', browser_download_url: 'https://example.test/macos.dmg' },
    { name: 'Gökdoğan_0.9.84_amd64.AppImage', browser_download_url: 'https://example.test/linux.AppImage' },
  ],
};
