...
echo "======================================================="
echo "   G O K D O G A N   -   macOS / Linux Başlat   "
echo "======================================================="
echo ""

# Check for stale docker-compose.yml from pre-migration clones
SCRIPT_DIR="$(cd "$(dirname "$0")" && pwd)"
export GOKDOGAN_LIVE_DATA="${GOKDOGAN_LIVE_DATA:-true}"
...
if ! command -v npm &> /dev/null; then
    echo "[!] HATA: npm kurulu değil. Node.js 18+ kurun (https://nodejs.org/)"
    exit 1
fi
