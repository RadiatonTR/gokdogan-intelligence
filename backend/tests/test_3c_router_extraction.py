...
6. Router registration order: mesh_peer_sync before mesh_public.
"""
...
class TestRouterRegistrationOrder:
    ...
    FastAPI matches routes in registration order. The HMAC-protected peer-sync
    routes must remain ahead of broader public mesh routes.
    """
