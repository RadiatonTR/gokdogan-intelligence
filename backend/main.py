...
# ---------------------------------------------------------------------------
# Router registry (R8: extracted from the legacy main.py monolith)
# ---------------------------------------------------------------------------
from router_registry import build_router_registry, register_routers

_router_registry = build_router_registry(_MESH_ONLY, logger)
...
app.add_middleware(
    ...
    allow_origin_regex=r"^(?:https?://(?:127\.0\.0\.1|localhost)(?::\d+)?|tauri://localhost|http://tauri\.localhost)$",
...
# Register routers
# ---------------------------------------------------------------------------
register_routers(app, _router_registry)
