...
_CRITICAL_WARN = {
    "ADMIN_KEY": "/api/settings ve /api/system/update için kimlik doğrulama anahtarı; dışa açık kurulumlarda yapılandırılması önerilir.",
    "OPENSKY_CLIENT_ID": "OpenSky Network OAuth2 isteğe bağlı zenginleştirmedir; yoksa uçuş katmanı anahtarsız ADS-B yedek kaynağıyla çalışır.",
    "OPENSKY_CLIENT_SECRET": "OpenSky OAuth2 gizli anahtarı; istemci kimliği ile birlikte isteğe bağlı zenginleştirme sağlar.",
}

_OPTIONAL = {
    "AIS_API_KEY": "AISStream canlı gemi akışı için isteğe bağlı anahtar; yoksa önbellek/yedek denizcilik kaynakları kullanılabilir.",
    "GFW_API_TOKEN": "Global Fishing Watch balıkçılık etkinliği katmanı için isteğe bağlı erişim belirteci.",
    "LTA_ACCOUNT_KEY": "Singapur LTA kamu trafik kameraları için isteğe bağlı hesap anahtarı.",
    "PUBLIC_API_KEY": "Kamu uçları için isteğe bağlı istemci kimlik doğrulaması; dışa açık kurulumlarda önerilir.",
}
