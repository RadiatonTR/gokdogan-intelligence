...
_SLOW_LAYER_KEYS: frozenset[str] = frozenset(
    {
        ...
        "crowdthreat", "malware_c2", "cyber_threats", "scm_suppliers",
        "viirs_nightlights", "road_corridor_trends",
    }
)
