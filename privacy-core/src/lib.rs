// MSVC prints an informational "creating import library" line on stdout for
// this cdylib. Rust 1.97 forwards that line through the linker_messages lint
// even though it is not a linker warning. Keep every other warning enabled.
